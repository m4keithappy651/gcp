...
echo -e "${BOLD}${GREEN}║                                                            ║${NC}"
echo -e "${BOLD}${GREEN}║           ${WHITE}𝗩𝗟𝗘𝗦𝗦 𝗚𝗖𝗣 𝗔𝗨𝗧𝗢 𝗗𝗘𝗣𝗟𝗢𝗬𝗘𝗥${GREEN}                           ║${NC}"
echo -e "${BOLD}${GREEN}║           ${CYAN}𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗯𝘆 𝗽𝗿𝘃𝘁𝘀𝗽𝘆𝘆𝘆${GREEN}                              ║${NC}"
echo -e "${BOLD}${GREEN}║                                                            ║${NC}"
echo -e "${BOLD}${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
check_enable_api() {
    ...
    if gcloud services list --enabled --filter="name:${API}" --format="value(name)" | grep -q "${API}"; then
        ...
        echo -e "        ${YELLOW}📡 𝗘𝗻𝗮𝗯𝗹𝗶𝗻𝗴... ${DISPLAY_NAME}...${NC}"
        gcloud services enable "${API}" --quiet
        echo -e "        ${GREEN}✓ 𝗘𝗻𝗮𝗯𝗹𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆${NC}"
    fi
}
...
echo -e "${BOLD}${WHITE}              𝗖𝗛𝗘𝗖𝗞𝗜𝗡𝗚 𝗥𝗘𝗤𝗨𝗜𝗥𝗘𝗗 𝗦𝗘𝗥𝗩𝗜𝗖𝗘𝗦${NC}"
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
...
# --- Build Docker Image ---
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
echo -e "${BOLD}${WHITE}              𝗕𝗨𝗜𝗟𝗗𝗜𝗡𝗚 𝗗𝗢𝗖𝗞𝗘𝗥 𝗜𝗠𝗔𝗚𝗘${NC}"
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
...
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
echo -e "${BOLD}${WHITE}           𝗣𝗨𝗦𝗛𝗜𝗡𝗚 𝗧𝗢 𝗖𝗢𝗡𝗧𝗔𝗜𝗡𝗘𝗥 𝗥𝗘𝗚𝗜𝗦𝗧𝗥𝗬${NC}"
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
...
# --- Deploy to Cloud Run ---
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
echo -e "${BOLD}${WHITE}              𝗗𝗘𝗣𝗟𝗢𝗬𝗜𝗡𝗚 𝗧𝗢 𝗖𝗟𝗢𝗨𝗗 𝗥𝗨𝗡${NC}"
echo -e "${BOLD}${MAGENTA}════════════════════════════════════════════════════════════${NC}"
...
echo -e "${BOLD}${GREEN}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BOLD}${GREEN}║                                                            ║${NC}"
echo -e "${BOLD}${GREEN}║           ${WHITE}𝗗𝗘𝗣𝗟𝗢𝗬𝗠𝗘𝗡𝗧 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟${GREEN}                              ║${NC}"
echo -e "${BOLD}${GREEN}║           ${CYAN}𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗯𝘆 𝗽𝗿𝘃𝘁𝘀𝗽𝘆𝘆𝘆${GREEN}                              ║${NC}"
echo -e "${BOLD}${GREEN}║                                                            ║${NC}"
echo -e "${BOLD}${GREEN}╠════════════════════════════════════════════════════════════╣${NC}"
echo -e "${BOLD}${GREEN}║                                                            ║${NC}"
...
echo -e "${BOLD}${GREEN}╠════════════════════════════════════════════════════════════╣${NC}"
echo -e "${BOLD}${GREEN}║                                                            ║${NC}"
echo -e "${BOLD}${GREEN}║  ${CYAN}𝗜𝗺𝗽𝗼𝗿𝘁 𝗨𝗥𝗜:${NC}                                             ${NC}"
